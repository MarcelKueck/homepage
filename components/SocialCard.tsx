...
export function SocialCard({
  ...
  return (
    <a
      ...
      aria-label={label}
      className="group flex flex-col items-center justify-center gap-3 rounded-3xl border border-border bg-bg-tertiary p-6 transition-colors hover:bg-bg-secondary hover:border-text-secondary/40 sm:p-8"
    >
